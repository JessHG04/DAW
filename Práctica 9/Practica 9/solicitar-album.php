        ...
        <form class="registro" id="formularioSolicitarAlbum" autocomplete="off" target="_self" action="solicitar-album-respuesta.php" method="post">
            <fieldset>
                ...
                <div>
                    ...
                    <input type="text" id="nombre" name="nomAlbumS" placeholder="Introduzca su nombre" required maxlength="200" title="Introduzca su nombre" size ="25"> (*)
                </div>

                <div>
                    <label for="album">Título del álbum:</label>
                    <input type="text" id="album" name="tituloAlbumS" placeholder="Introduzca el título del álbum" required maxlength="200" title="Introduzca el título del álbum" size ="25"> (*)
                </div>

                <div>
                    <label for="texto">Texto adicional:</label>
                    <textarea rows="4" cols="60" id="texto" name="descAlbumS" placeholder="dedicatoria, descripción de su contenido, etc." maxlength="4000" title="dedicatoria, descripción de su contenido, etc."></textarea>
                </div>

                <div>
                    <label for="email">Correo electrónico:</label>
                    <input type="email" id="email" name="emailAlbumS" autocomplete="on" placeholder="Introduzca su email" required maxlength="200" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="Introduzca su email" size ="25"> (*)
                </div>

                <div id="direccion">
                    <label for="calle">Dirección:</label>
                    <input type="text" id="calle" name="calleAlbumS" placeholder="Calle" required title="Introduzca su calle" size ="25">
                    <input type="number" id="numero" name="nCalleAlbumS" min="1" max="500" step="1" placeholder="Número" required>
                    <input type="text" id="puerta" name="puertaAlbumS" placeholder="Puerta" title="Introduzca su puerta" size ="25">
                    <input type="number" id="cp" min="0" name="cpAlbumS" max="99999" step="1" placeholder="CP" size="25" required>

                    <input type="text" id="localidad" name="localidadAlbumS" placeholder="Localidad" required title="Introduzca su localidad" size ="25">

                    <input type="text" id="provincia" name="provinciaAlbumS" placeholder="Provincia" required title="Introduzca su provincia" size ="25">
                ...
                <div>
                    ...
                    <input type="number" name="telAlbumS" id="telefono" min="0" max="999999999" size="25" step="1" placeholder="Teléfono">
                </div>

                <div>
                    <label for="calbum">Color de la portada:</label>
                    <input type="color" name="cPortadaAlbumS" id="calbum" value="#000000">
                </div>
                ...
                <div>
                    ...
                    <select id="aphotory" name="albumS">
                    <?php
                ...
                <div>
                    ...
                    <input type="date" id="fechar" name="fechaRecAlbumS" title="Introduzca la fecha en la que le gustaría recibirlo"> Fecha aproximada
                </div>
