...
?>
<main>
    <form class="registro" autocomplete="off" target="_self" action="subir-foto-respuesta.php" method="post" enctype="multipart/form-data">
        <fieldset>
            ...
            <div>
                ...
                <input type="date" name="fechaFoto" id="datePhoto" title="Introduzca la fecha en la que se realizó la foto">
            </div>
            ...
            <div>
                ...
                <span class="icon-upload"></span><input type="file" name="nfileFoto" required id="nfileFoto" accept="image/*" class="boton">
            </div>
